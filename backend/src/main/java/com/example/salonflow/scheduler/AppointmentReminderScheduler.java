...
/**
 * Cron job chạy mỗi 15 phút để gửi SMS nhắc hẹn trước 24h và 1h (US-037).
 */
@Component
...
public class AppointmentReminderScheduler {
    ...
    /**
     * Chạy mỗi 15 phút.
     * Check booking sắp tới trong khoảng 24h và 1h để gửi SMS nhắc.
     */
    @Scheduled(cron = "0 */15 * * * *")
    @Transactional
    public void sendAppointmentReminders() {
        ...
        // Lấy tất cả booking CONFIRMED hoặc PENDING trong khoảng ngày cần check
        ...
        log.info("=== [US-037] Ket qua: gui 24h={}, gui 1h={}, bo qua={} ===",
