...
// import + @Service, vì entity com.example.salonflow.entity.Service cũng
// được dùng (fully-qualified) trong file này — import cả hai cùng lúc
// sẽ gây lỗi biên dịch "duplicate class: Service".
@Slf4j
...
public class RecurringBookingServiceImpl implements RecurringBookingService {
    ...
    public RecurringBookingResponse confirm(
        ...
        com.example.salonflow.entity.Service service =
                findService(request.getServiceId());
        User staff = findUser(request.getStaffId());
    ...
    private com.example.salonflow.entity.Service findService(Long serviceId) {
